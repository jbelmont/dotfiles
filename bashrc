...
export OSH=/Users/marcel.belmont/.oh-my-bash
...
# User configuration
alias tf_plan='terraform plan -var-file=../shared.tfvars '
alias tf_apply='terraform apply -var-file=../shared.tfvars '
alias tf_destroy='terraform destroy -var-file=../shared.tfvars '
alias tf_init='terraform init --upgrade=true'
