...
plugins=(vi-mode urltools web-search brew cpanm dircycle fabric osx rsync textmate torrent screen ruby mercurial perl colorize colored-man python \
  compleat copydir git-extras git-hubflow github git-flow git ssh-agent themes zsh-syntax-highlighting osx fasd per-directory-history)
...
#alias my_server_jbelmont="ssh -ljbelmont 216.158.67.244"
